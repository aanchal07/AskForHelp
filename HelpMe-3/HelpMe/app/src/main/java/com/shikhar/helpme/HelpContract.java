...
public class HelpContract implements BaseColumns {
    ...
    public static final String WORKER_TABLE_USERNAME_COL="Worker_Username";
    ...
    public static final String WORKER_TABLE_PHONE_NO_COL="Phone_Number";
    ...
    public static final String AVAILABLE_TABLE_ID="AVAILABLE_ID";
    public static final String AVAILABLE_TABLE_DATE_COL="Date";
    public static final String AVAILABLE_TABLE_WORKER_ID_COL="Worker_ID";

    public static final String HISTORY_TABLE="History";
    public static final String HISTORY_TABLE_ID="HISTORY_ID";
    public static final String HISTORY_TABLE_WORKER_ID_COL="Worker_ID";
    public static final String HISTORY_TABLE_DATE_COL="Date";
    public static final String HISTORY_TABLE_CHARGES_COL="Charges";
    public static final String HISTORY_TABLE_MY_RATING_COL="My_Rating";
    ...
    public static final String USER_TABLE_PHONE_NO_COL="Phone_Number";
    public static final String USER_TABLE_NAME_COL="Name";
    public static final String USER_TABLE_ADDRESS_COL="Address";
    public static final String USER_TABLE_HISTORY_ID_COL="History_ID";
}

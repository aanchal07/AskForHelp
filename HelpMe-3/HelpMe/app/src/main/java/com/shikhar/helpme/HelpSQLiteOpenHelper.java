...
public class HelpSQLiteOpenHelper extends SQLiteOpenHelper {
    public HelpSQLiteOpenHelper(Context context) {
        super(context, HelpContract.DB_NAME , null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE Worker (WORKER_ID INTEGER PRIMARY KEY AUTOINCREMENT,"
                +HelpContract.WORKER_TABLE_NAME_COL+" TEXT,"
